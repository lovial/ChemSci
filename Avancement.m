...
Constants = K(1:4); % Association constants
DHG = K(5:9); %Ratio of induced 1H NMR signal displacement upon second binding event by that of first binding event.
...
%%  Calculated 1H NMR signal displacement of(pR)3pS / (pS)3pR
    Result(i,6) = Dmax(6)*(Hi(4)-Residuals(i,4))/Hi(4);
end
