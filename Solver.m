...
KA4H1= Constants(4); %Association constant of (pR)2(pS)2 with cadaverine.
...
F(4) = Hi(4) - GH(4) - KA4H1*GH(4)*GH(5);
%% Mass Balance on Guest
F(5) = G0 - GH(5) -  KA41*GH(1)*GH(5) - KA31*GH(2)*GH(5) - KA4C11*GH(3)*GH(5) - 2*KA4C11*KA4C12*GH(3)*GH(5)^2 - KA4H1*GH(4)*GH(5);
